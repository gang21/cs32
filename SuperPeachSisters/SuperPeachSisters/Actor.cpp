...
Block::Block(int x, int y, int goodie) : Actor(this, x, y, IID_BLOCK, 0, 2, 1, true) {
    m_goodie = goodie;
}
...
void Block::getBonked() {
    if (m_goodie == -1)
        ...
        return;
    //function for object to release
    getWorld()->(SOUND_POWERUP_APPEARS);
    return;
}
//
////Peach class implementation
//Peach::Peach(int x, int y) : Actor(this, x, y, IID_PEACH, 0, 0, 1, true) {
//    m_healthPts = 1;
